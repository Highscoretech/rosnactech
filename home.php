...
$sql = "SELECT * FROM `login` WHERE email = '{$emaili}' " ;
           ...
           <ul>
            ...
            <li class="relative px-6 py-3">
              ...
              >
                ...
                <span class="ml-4">Cashout balance</span>
              </a>
            </li>
            <li class="relative px-6 py-3">
              <a
              ...
              >
                ...
                <span class="ml-4">Cashout referral bonus</span>
              </a>
            </li>
            <li class="relative px-6 py-3">
              <a
              ...
              <template x-if="isPagesMenuOpen">
                ...
                >
                  ...
                  <li
                    class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                  >
                    <a class="w-full" href="pages/blank.html">Blank</a> c
                  </li>
                </ul>
              </template>
            </li>
          ...
          <ul>
            ...
            <li class="relative px-6 py-3">
              ...
              >
                ...
                <span class="ml-4">Withdraw balance</span>
              </a>
            </li>
            <li class="relative px-6 py-3">
              <a
              ...
              >
                ...
                <span class="ml-4">Withdraw referral bonus</span>
              </a>
            </li>
            <li class="relative px-6 py-3">
              <!-- <script>
                ...
                function active(){
                  megEl.textContent = "Task is not out yet";
                }
